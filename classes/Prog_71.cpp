...
class Prostokat
{
	...
	public:
		Prostokat(int _x, int _y, int _bok1, int _bok2): x(_x), y(_y), bok1(_bok1), bok2(_bok2) 
		{};
...
{
	public:
		Kwadrat(int _x, int _y, int _bok): Prostokat(_x,_y,_bok,_bok) 
		{}
